...
public class VoterData  {
    ...
    public String getVoterMandal() {
        return voterMandal;
    }

    public void setVoterMandal(String voterMandal) {
        this.voterMandal = voterMandal;
    }

    public String getVoterDrno() {
        return voterDrno;
    }
    ...
    public String getVoterLandmark() {
        return voterLandmark;
    }

    public void setVoterLandmark(String voterLandmark) {
        this.voterLandmark = voterLandmark;
    }
